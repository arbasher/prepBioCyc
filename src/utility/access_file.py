...
def load_y_data(file_name, load_path, tag='labels sample'):
    try:
...
def load_data(file_name, load_path, load_X=False, mode='rb', tag='data'):
    '''
    :param data:
...
def load_json(file_name, load_path, tag='data'):
    '''
    Save edus into file
    :param data:
    :param load_path: load file from a path
